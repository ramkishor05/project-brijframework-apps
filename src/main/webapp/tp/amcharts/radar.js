AmCharts.AmRadarChart = AmCharts.Class({inherits: AmCharts.AmCoordinateChart, construct: function (a) {
  this.type = "radar";
...
AmCharts.RadItem = AmCharts.Class({construct: function (a, b, c, d, m, p, e, f) {
  void 0 === c && (c = "");
  ...
  if (1 == m && 0 < y && !e && "" !== c) {
    ...
    } else s = AmCharts.wedge(r, 0, 0, 0, 360, b, b, e, 0, {fill: B, "fill-opacity": y, stroke: "#000", "stroke-opacity": 0,
      "stroke-width": 1});
    d.push(s);
    s.translate(p, F)
  }
...
AmCharts.RadarFill = AmCharts.Class({construct: function (a, b, c, d) {
  ...
  } else this.fill = AmCharts.wedge(c, 0, 0, f, d - f, m, m, b, 0, {fill: e, "fill-opacity": p, stroke: "#000", "stroke-opacity": 0, "stroke-width": 1});
